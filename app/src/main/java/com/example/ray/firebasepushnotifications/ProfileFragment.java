    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        mFirestore.collection("Users").document(mUserId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                RequestOptions placehodlerOption = new RequestOptions();
                placehodlerOption.placeholder(R.drawable.default_image);

                mProfileName.setText(user_name);
                Glide.with(container.getContext()).setDefaultRequestOptions(placehodlerOption).load(user_image).into(mProfileImage);
            }
        });
